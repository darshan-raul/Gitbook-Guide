...
![1 passed 2 warnings as the end result](../../../.gitbook/assets/image%20%2837%29.png)

Now I removed the s3 access for this AWS user and re-ran the test

![As expected it failed with 1 failed,2 warnings](../../../.gitbook/assets/image%20%2876%29.png)

![You will also see a F in front of the file](../../../.gitbook/assets/image%20%2857%29.png)
